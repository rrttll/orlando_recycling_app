...
import 'package:orlando_recycling_app/screens/settings_screen.dart' as SettingsScreen;
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SettingsScreen.SettingsScreen()),
              );
            },
          ),
        ],
      ...
      children: <Widget>[
        Row(
          ...
          children: [
            CircleAvatar(
              radius: 50.0,
              backgroundImage: AssetImage('assets/afro_girl.gif'), // Assuming the animated girl image is in assets
            ),
            SizedBox(width: 10.0),
            Text(
              '$_username',
          ...
          children: [
            Row(
              ...
              children: List.generate(9, (index) {
                return CircleAvatar(
                  backgroundColor: index < 3 ? Color.fromARGB(255, 60, 221, 100) : Colors.grey,
                  child: Icon(
                    Icons.circle,
                    color: Colors.black,
                  ),
